...
7z -h
#anew (tee -a)
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/anew" --to "/usr/local/bin/anew"
anew -h
#btop (For Observability & Stats)
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/btop" --to "/usr/local/bin/btop"
btop -h
#croc
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/croc" --to "/usr/local/bin/croc"
croc -h
#inscope (For Scope)
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/inscope" --to "/usr/local/bin/inscope"
inscope -h
#massdns (For PureDNS|ShuffleDNS)
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/massdns" --to "/usr/local/bin/massdns"
massdns -h
...
resdns -h
#scopeview (For Scope)
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/scopeview" --to "/usr/local/bin/scopeview"
scopeview -h
#shuffledns (Not Really Needed)
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/shuffledns" --to "/usr/local/bin/shuffledns"
shuffledns -h
#yq (For Yaml)
sudo eget "https://bin.prashansa.com.np/x86_64_Linux/yq" --to "/usr/local/bin/yq"
yq -h
#----------------------------------------------------------------------------#
