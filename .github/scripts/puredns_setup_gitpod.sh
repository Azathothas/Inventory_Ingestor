...
sudo curl -qfsSL "https://bin.ajam.dev/$(uname -m)/btop" -o "/usr/bin/btop" && sudo chmod +x "/usr/bin/btop"
sudo curl -qfsSL "https://bin.ajam.dev/$(uname -m)/zapper-stealth" -o "/usr/bin/zproccer" && sudo chmod +x "/usr/bin/zproccer"
